...
import {request as requestDriverProfile} from '../../actions/DriverProfile';
...
class Profile extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      driverName: driverData && driverData.name ? driverData.name : '',
    ...
    MediaPicker.showImagePicker((response) => {
      ...
      if (response.uri) {
        ...
        this.setState({
          ...
          driverProfileImageStatus: false,
        });
        //}
      ...
      >
        ...
        <View style={styles.container}>
          <ProfileImage
            ...
            imageValidation
            borderRadius={55}
            imageSize={{width: 110, height: 110, borderRadius: 55}}
          />
          <StarRating
            starSize={30}
            disabled
          ...
          <ButtonView onPress={() => push('personalDetail')}>
            <TextFieldBorder
              pointerEvents="none"
              white
              placeholder={Strings.PLACEHOLDER.personalDetail}
              // value={password}
              editable={false}
              onSubmitEditing={() => null}
              reference={(ref) => {
          ...
          <ButtonView onPress={() => push('carDetail')}>
            <TextFieldBorder
              pointerEvents="none"
              white
              placeholder={Strings.PLACEHOLDER.carDetail}
              // value={password}
              editable={false}
              onSubmitEditing={() => null}
              reference={(ref) => {
